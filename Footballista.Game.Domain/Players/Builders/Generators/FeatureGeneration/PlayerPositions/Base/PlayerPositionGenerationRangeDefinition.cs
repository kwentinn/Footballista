...
namespace Footballista.Game.Domain.Players.Builders.Generators.FeatureGeneration.PlayerPositions.Base
{
    public abstract class PlayerPositionGenerationRangeDefinition
    {
        ...
        protected void AddBadSkills(params FeatureType[] featureTypes) => AddSkills(featureTypes, MinRange);
        protected void AddMediumSkills(params FeatureType[] featureTypes) => AddSkills(featureTypes, MediumRange);
        protected void AddBestSkills(params FeatureType[] featureTypes) => AddSkills(featureTypes, MaxRange);
